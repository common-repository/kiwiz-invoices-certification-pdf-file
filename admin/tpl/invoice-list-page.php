...
$settings = array_map('sanitize_text_field', (array) Kiwiz_Invoice_List::get_settings());
?>
<div class="kiwiz-listing-factures">
    <div class="wrap">

        <h1><?php echo __('Invoices list', 'kiwiz-invoices-certification-pdf-file');?></h1>
                            ...
                            Kiwiz_Admin::render_fields(
                                array(
                                    ...
                                    'options'       => array(   'p.ID ASC'              => __('No. ascending order', 'kiwiz-invoices-certification-pdf-file'),
                                                                ...
                                                                'pmnf.meta_value ASC'   => __('No. ascending invoice', 'kiwiz-invoices-certification-pdf-file'),
                                                                'pmnf.meta_value DESC'  => __('No. descending invoice', 'kiwiz-invoices-certification-pdf-file'),
